 ...
 */
@WebServlet("/order/getOrderDataServletOld")
public class GetOrderDataServletOld extends HttpServlet{
...
//			}
		...
		case "sessionFood" :
			...
			if (sessionfood==null || sessionfood.size()==0) {
				...
				session.setAttribute("foods", service.getAllFoods());
			} else {
		...
		case "sessionSet" :
			...
			if (sessionset==null || sessionset.size()==0) {
				...
				session.setAttribute("sets", service.getAllSets());
			} else {
		...
		case "sessionTable" :
			...
			if (sessiontable==null || sessiontable.size()==0) {
				...
				session.setAttribute("tables", service.getAllTables());
			} else {
