...
<title>BDY RMS - InsertNewMA</title>
</head>
<body>
...
<div id="article">
	...
	<form action="<c:url value="/secure/insertMakeArea.action" />"   method="post">
	
	<p >製作區域名稱 :<input name="maName" type="text" value="${param.maName }"><s:property value="%{fieldErrors['maName'][0]}"/></p>
	<input class='MainBtnColor' type="submit" value="確認">
	<input class='MainBtnColor' type="button" value="取消" onclick="cancelMA()">
	</form>
