...
<div id="article">
    ...
    <div id="addBooking" title="新增訂位" style="display:none">
	    <form id="addBookingForm" name="addBookingForm">
		    ...
		    <p class="formLabel">*電話：<span class="error" id="phoneError"></span></p>
		    <input name="phone" type="text">
		    <p class="formLabel">*人數：<span class="error" id="numberError"></span></p>
		    <input name="number" type="number">
		    <p class="formLabel">*用餐時間：<span class="error" id="eatDateError"></span></p>
		    <input style="width:110px" id="FormDatePicker" size="10" name="eatDate" type="text">
